...
SECRET_KEY = "django-insecure-5e-w6+@d(+ywiry1k*u7qauxd@p^ua81)2trs5*yg2zx6nm1!b"  # noqa: S105
...
MIDDLEWARE = [
    ...
    # Add the WindowsAuthTokenMiddleware somewhere before the RemoteUserMiddleware
    "django_windowsauthtoken.middleware.WindowsAuthTokenMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    # Make sure RemoteUserMiddleware comes after AuthenticationMiddleware
